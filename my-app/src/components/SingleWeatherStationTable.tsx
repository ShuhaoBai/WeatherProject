...
//     props:
//       | ISingleWeatherStationTableProps
//       | Readonly<ISingleWeatherStationTableProps>
//   ) {
//     super(props);
//     this.state = {
//       page: 0,
...
import React from 'react';
import { fetchSingleStation, fetchStationsWithinRange } from '../api';
...
> {
  async componentDidMount() {
    ...
    // console.log(this.state.elevation, this.state.elevationUnit, this.state.id);
  }
  render() {
    return (
      <div>
